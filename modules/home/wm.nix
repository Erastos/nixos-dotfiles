...
in
{
  options.netscape.home.wm = {
    river = {
      enable = lib.mkEnableOption "River wayland compositor" // { default = isLaptop; };
    };

    waybar = {
      enable = lib.mkEnableOption "Waybar status bar" // { default = isLaptop; };
    };
  };
  ...
  config = lib.mkMerge [
    ...
    (lib.mkIf cfg.river.enable {
      ...
      wayland.windowManager.river = {
        ...
        launcher="dmenu_run"
        terminal="foot"
        wallpaper="/home/netscape/Pictures/wp8191974.jpg"
        ...
        riverctl border-color-focused 0x${colors.brightRed}
        riverctl border-color-unfocused 0x${colors.red}
